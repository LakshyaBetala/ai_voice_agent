...
TOP_HOT_PHRASES: dict[str, list[str]] = {
    ...
    "ta-IN": [
        ...
        "Sari sari.",
        "Innum oru kelvi.",
        "Ungaloda time price-aanadhu, naan quickly mudichuren.",
        "Naan ungalukku quote anuparen.",
        "Sample venum-naa anuppa mudiyum.",
        "WhatsApp-la details anuppa-laama?",
        "Ungaloda peese romba nalla irundhuchu.",
        "Andha problem ungalukku irukka?",
        "Adhanale enna impact aagudhu?",
        "Ovvoru maathamum yevvalavu venum?",
    ],
}
...
ACK_CLIPS: dict[str, list[str]] = {
    ...
    "ta-IN": ["Sari.", "Aama.", "Puriyudhu.", "Sari sari."],
}
